...
<table width="100%" border="1">
  ...
  <tr>
    ...
    <td><img src="modules/quanlysanpham/img/<?php echo $dong['hinhanh'] ?>" width="80" height="80" />
    ...
    ?></td>
    <td><a href="index.php?quanly=sanpham&ac=sua&id=<?php echo $dong['idsanpham'] ?>" ><center><img src="../img/edit.png" width="30" height="30" /></center></a></td>
    <td><a href="modules/quanlysanpham/xuly.php?id=<?php echo $dong['idsanpham']?>" class="delete_link"><center><img src="../img/delete.png" width="30" height="30"   /></center></a></td>
  </tr>
  <?php
  $i++;
  }
