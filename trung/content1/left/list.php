...
?>
            ...
            <div class="tieude">
				...
				?>
                	<li><a href="index.php?quanly=nhanhieusp&id=<?php echo $dong_hieu['idhieusp'] ?>"><?php echo $dong_hieu['tenhieusp'] ?></a></li>
                  <?php
				}
				  ?>
                </ul>
				...
				?>
                	<li><a href="?quanly=chitietsp&idloaisp=<?php echo $dong_banchay['loaisp'] ?>&id=<?php echo $dong_banchay['idsanpham'] ?>">
                    	<img src="admin/modules/quanlysanpham/img/<?php echo $dong_banchay['hinhanh'] ?>" width="150" height="150" />
				...
				?>
                	<li><a href="#">
                    	<p style="float:left;"><img src="admin/modules/quanlytintuc/uploads/<?php echo $dong_tin['hinhanh'] ?>" width="40" height="30" /></p>
